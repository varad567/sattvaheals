...
const css = `
  ...
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
  ...
  .bl-nav-brand{font-family:'Cormorant Garamond',serif;font-size:18px;font-weight:600;color:var(--pearl);letter-spacing:4px;text-transform:uppercase;cursor:pointer;text-decoration:none;line-height:1;display:flex;align-items:center;}
  .bl-nav-brand span{color:var(--gold);}
  .bl-nav-back{background:none;border:none;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:var(--pearl-dim);cursor:pointer;display:flex;align-items:center;gap:10px;transition:color 0.2s;font-family:'Outfit',sans-serif;line-height:1;}
